...
Route::get('/tutor/payment/{id}', [App\Http\Controllers\TutorController::class, 'payment']);
Route::post('/tutor/payment', [App\Http\Controllers\PaymentController::class, 'store']);
