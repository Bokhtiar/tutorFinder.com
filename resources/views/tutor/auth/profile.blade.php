                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab"
                                    data-bs-target="#tutor_education">Tutor education</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{$show->fee}}Tk</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Location</div>
                                    <div class="col-lg-9 col-md-8">{{$show->village ? $show->village->village_name : ""}} , {{$show->state ? $show->state->state_name : ""}}, {{$show->city ? $show->city->city_name : ""}}, {{$show->country ? $show->country->country_name : ""}}</div>
                                </div>
                            </div>
