    ...
    <section class="container mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="w-80 h-60 bg-gray-50 rounded text-center">
                <div class="">
                    <img class=" rounded-full h-24 w-24 mx-auto my-7" src="https://attraxcdnprod1-freshed3dgayb7c3.z01.azurefd.net/1481118/739eb969-c402-42a7-9764-652d438952f3/2023.17000.89/img/2e31cb98-25a9-4b0e-1466-08d95833968a" alt="">
                </div>
            ...
            <div class="w-80 h-60 bg-gray-50 rounded text-center">
                <div class="">
                    <img class=" rounded-full h-24 w-24 mx-auto my-7" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDz3lDSq4-9VytbswmVqDRuGlDtnYvTzymaQ&usqp=CAU" alt="">
                </div>
