...
@section('content')
    ...
    <section class="container mx-auto my-40" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="w-80 h-48 bg-gray-100 rounded text-center">
                ...
                <h4 class="text-xl text-gray-400 font-bold">200 +</h4>
            </div>
            ...
            <div class="w-80 h-48 bg-gray-100 rounded text-center">
                ...
                <h4 class="text-xl text-gray-400 font-bold">500 +</h4>
            </div>
            ...
            <div class="w-80 h-48 bg-gray-100 rounded text-center">
                ...
                <h4 class="text-xl text-gray-400 font-bold">50 +</h4>
            </div>
            ...
            <div class="w-80 h-48 bg-gray-100 rounded text-center">
                ...
                <h4 class="text-xl text-gray-400 font-bold">10 +</h4>
            </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            @forelse ($services as $item)
                <div class="w-80 h-60 bg-gray-50 rounded text-center">
                    <div class="">
                        <img class=" rounded-full h-24 w-24 mx-auto my-7" src="{{ asset($item->image) }}" alt="">
                    </div>

                    <h3 class="text-xl text-green-400 font-bold">{{ $item->title }}</h3>
                    <h4 class="text-base text-gray-400">{{ $item->body }}</h4>
                </div>
            @empty
            @endforelse
            {{-- service end here --}}
    ...
    <section id="tutor" class=" container mx-auto" data-aos="fade-left" data-aos-offset="500" data-aos-duration="500">
        ...
        <div id="tutorShow" class="grid grid-cols-2 md:grid-cols-5 gap-3 mt-8">
